...
use crate::{
    ...
    loader::{ComponentDefinition, ComponentLoader, ComponentSource, RuntimeRegistry},
};
...
impl<T: ComponentTrait> RuntimeRegistry<T> for DefaultRegistry<T> {
    ...
    ) -> Promise<Result<HashMap<String, &'static (dyn ComponentDefinition<T> + Send + Sync)>, String>>
    {
        todo!()
    }
